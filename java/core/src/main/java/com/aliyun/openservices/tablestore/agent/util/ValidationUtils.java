...
public class ValidationUtils {
     ...
     * @throws IllegalArgumentException if the expression is false.
     */
    public static long ensureGreaterThanZero(Long i, String name) {
        if (i == null || i <= 0) {
    ...
    public static long ensureGreaterThanAndEqualZero(Long i, String name) {
        if (i == null || i < 0) {
            throw Exceptions.illegalArgument("%s must be greater than and equal zero, but is: %s", name, i);
        }
