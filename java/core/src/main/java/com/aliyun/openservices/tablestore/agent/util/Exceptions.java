...
public class Exceptions {
     ...
     *
     * <p>
     * Equivalent to {@code new IllegalArgumentException(String.format(format, args))}.
     *
     ...
     *
     * <p>
     * Equivalent to {@code new RuntimeException(String.format(format, args))}.
     *
     * @param format the format string
     * @param args   the format arguments
     * @return the constructed exception.
    ...
    public static RuntimeException runtimeThrowable(String msg, Throwable cause) {
