...
public class TablestoreVectorStore extends AbstractObservationVectorStore implements InitializingBean {
    ...
    public TablestoreVectorStore(Builder builder) {
        super(builder);
    ...
    public void doAdd(List<Document> documents) {
        ...
        for (int i = 0; i < documents.size(); i++) {
            ...
            knowledgeStore.putDocument(Utils.toTablestoreDocument(knowledgeStore.enableMultiTenant(), embedding, document));
        }
    }
    ...
    protected void doDelete(Filter.Expression filterExpression) {
        ...
        var metadataFilter = TablestoreExpressionConverter.convertOperand(filterExpression, tenantIds, knowledgeStore.enableMultiTenant());
    ...
    public VectorStoreObservationContext.Builder createObservationContextBuilder(String operationName) {
        VectorStoreObservationContext.Builder builder = VectorStoreObservationContext.builder("tablestore", operationName);
